...
function CommandDialog({
  ...
  /** Forwarded to the cmdk root. Set false when filtering server-side. */
  shouldFilter?: boolean
  /** Controlled highlighted-item value (cmdk root). */
  commandValue?: string
  ...
  return (
    <Dialog {...props}>
      ...
      >
        {/* Title/description live inside DialogContent so Radix can wire
